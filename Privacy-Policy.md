...
- __Application__ refers to Edunext Auto Tool, the software program provided by the Company.

- __Company__ (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Edunext Auto Tool.
...
- __Website__ refers to Edunext Auto Tool, accessible from [https://github.com/Kunniii/edn_auto_ext](https://github.com/Kunniii/edn_auto_ext)
...
- By email: <contact@codechovui.dev>
